...
COMP            = $(CC) $(DEFINES) $(CFLAGS) $(CFLAGS_TGT) -I $(shell dirname $<) -o $@ -c $<
LINK            = $(CC) $(LDFLAGS_TGT) $(LDFLAGS) -o $@ $^ $(LDLIBS) $(LDLIBS_TGT)
COMPLINK        = $(CC) $(DEFINES) $(CFLAGS) $(CFLAGS_TGT) -I $(shell dirname $<) $(LDFLAGS_TGT) $(LDFLAGS) -o $@ $< $(LDLIBS) $(LDLIBS_TGT)
SHAREDLIB       = $(CC) --shared $(LDFLAGS_TGT) $(LDFLAGS) -o $@ $^ $(LDLIBS) $(LDLIBS_TGT)
...
.PHONY: install
install: all
	[ -z "$(TGT_BIN)" ] || $(INSTALL) -m 755 -D -t $(BINDIR) $(TGT_BIN)
	[ -z "$(TGT_SBIN)" ] || $(INSTALL) -m 755 -D -t $(SBINDIR) $(TGT_SBIN)
	[ -z "$(TGT_LIB)" ] || $(INSTALL) -m 755 -D -t $(LIBDIR) $(TGT_LIB)
