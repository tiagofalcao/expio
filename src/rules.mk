...
$(OBJS_$(d)):	CFLAGS_TGT = $(INCLUDES_sqlite3) $(CFLAGS_sqlite3)
$(OBJS_$(d)):	$(HEADERS_$(d)) | $(BUILDDIR)/$(d)

$(BUILDDIR)/$(d)/lib$(PACKAGE).so:	LDFLAGS_TGT = $(LINKFLAGS_sqlite3)
$(BUILDDIR)/$(d)/lib$(PACKAGE).so:	LDLIBS_TGT = $(LIBPATH_sqlite3) $(LIB_sqlite3)
